...
4. **Any frontend / UI / CSS / page work:** read `docs/frontend.md` fully and follow it literally (it overrides generic UI habits).
5. **Any API wiring:** read `docs/api.md`.
6. Load matching skills from `skills/` or `.cursor/skills/`.
